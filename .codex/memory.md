...
- 2026-06-16 five-year gallery timeline: the authenticated months gallery now renders 60 month slots grouped into 5 year sections (`0-59`). Nested object keys and hero keys accept months `0` through `59`, and the upload URL Lambda validation now allows the same range. Browser QA used temporary mock `http://127.0.0.1:8001/everyday-lilly-60-months-qa.html`: overview showed 5 year sections, 60 month cards, month 59 was present, opening month 59 showed `Година 5 · Месец 11` and kept `Upload pictures` as the last tile.
